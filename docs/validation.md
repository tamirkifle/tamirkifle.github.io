...
- `npm run check`: 18 generated pages; 273 local link, asset, and anchor references; one main heading per page; domain preserved; draft titles absent from public lists.
...
- `npm test`: 12 routes, 30 responsive combinations, 11 axe scans, and 7 interaction checks passed.
