Vision Profiler is a benchmarking harness for four PyTorch vision models. It was built as a three-person course project to compare the models through the same measurement path on the same GPU.
